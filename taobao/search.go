...
var TaobaoSearch = &Spider{
	Name:        "淘宝天猫搜索-justcy",
	Description: "淘宝天猫搜索结果 [s.taobao.com],author by justcy",
	 Pausetime: 300,
	Keyin:        KEYIN,
	Limit:        LIMIT,
	EnableCookie: true,
				...
				AidFunc: func(ctx *Context, aid map[string]interface{}) interface{} {
					for loop := aid["loop"].([2]int); loop[0] < loop[1]; loop[0]++ {
						ctx.AddQueue(&request.Request{
							...
							Url:  "https://s.taobao.com/search?q=" + ctx.GetKeyin() + "&ie=utf8&cps=yes&app=vproduct&cd=false&v=auction&tab=all&vlist=1&bcoffset=1&s="+strconv.Itoa(loop[0]*44)+"&ntoffset=1" ,
